      ...
      {loading ? (
        ...
        <>
          <div className="row justify-content-around mt-5 user-info">
            <div className="col-12 col-md-5 profile bg-opacity-50">
              ...
              <h4>Full Name</h4>
              <p className="fixUp">{user.name}</p>

              <h4>Email Address</h4>
              <p className="fixUp">{user.email}</p>

              <h4>Joined On</h4>
              <p className="fixUp">{String(user.createdAt).substring(0,10)}</p>
